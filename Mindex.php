...
<section>
    <div id="admin_box">
        ...
        <ul id="member_list">
            ...
            $sql = "select * from cafe order by num desc";
            ...
            while ($row = mysqli_fetch_array($result))
            {
                ...
                ?>
                <li>
                    <form method="post" action="manager_member_update.php?num=<?=$num?>">
                        ...
                        <span class="col8"><button type="button" onclick="location.href='manager_member_delete.php?num=<?=$num?>'">삭제</button></span>
                    </form>
                </li>
                <?php
                $number--;
        ...
        <ul id="board_list">
            <li class="title">
                ...
                <span class="col6">첨부파일명</span>
                <span class="col6">작성일</span>
            </li>
            <form method="post" action="manager_board_delete.php">
                <?php
                $sql = "select * from cafeboard order by num desc";
                $result = mysqli_query($con, $sql);
